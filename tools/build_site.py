...
.chip {
  ...
  border-radius: 999px; padding: 8px 14px; min-height: 36px; display: inline-flex;
...
.back {
  font-size: 0.95rem; display: inline-flex; align-items: center; min-height: 40px;
  padding: 4px 2px; margin: -4px -2px;
}
button.plain {
  border: 1px solid var(--line); background: var(--card); color: var(--ink);
  border-radius: 10px; padding: 10px 16px; min-height: 40px; font-size: 0.9rem; cursor: pointer;
}
